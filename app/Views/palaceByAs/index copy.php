                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                        ...
                                        <td colspan="9" style="padding-bottom: 0;padding-left:0 !important;padding-right: 0 !important;">
                                            <div class="w3-code notranslate htmlHigh ms-0 bar-1">
                                                ...
                                                <div class="form-group mb-0">
                                                    <!-- <a style="    float: right;
                                            margin-top: -22px;
                                            margin-right: -7px;" href="{{ route('personel-management.table1.add') }}" data-controller="button" data-turbo="true" class="btn  btn-default" type="submit" form="post-form" formaction="https://demo.orchid.software/example-fields/buttonClickProcessing">
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td><div class="dhx_demo-active">พ.อ.(พ.)</div></td> -->
                                        <td class="text-center"><button type="button" class="btn btn-outline-success waves-effect waves-light w-md btn-rounded">พ.อ.(พ.)</button></td>
                                        <td></td>
                                        <td>สูง</td>
                                        <td><button type="button" class="btn btn-outline-danger waves-effect waves-light w-md btn-rounded">ว่าง</div></td>
                                        <td></td>
                                        <td></td>
