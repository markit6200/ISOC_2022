                                    ...
                                    <td style="width: 13rem;text-align:center;">
                                        <div class="col-auto pe-md-0">
                                            <div class="form-group mb-0">
                                                ...
                                                <?php $mId=1;?>
                                                <button class="btn  btn-danger"  onclick="updateDistribute('<?php echo $mId;?>')">
                                        ...
                                        <div class="col-auto pe-md-0">
                                            <div class="form-group mb-0">
                                                <button class="btn  btn-danger" data-bs-toggle="modal"
                                                    data-bs-target="#distributeModal1">
                                                    <i class="mdi mdi-close-circle-outline"></i>&nbsp;พ้น
                                                </button>
                                            </div>
                                        </div>
...
<?= $this->include('palaceByAs/viewDistributeBlade') ?>

<!-- Sweet Alerts js -->
<script src="assets/libs/sweetalert2/sweetalert2.min.js"></script>

<script>
function updateDistribute(mId) {
    Swal.fire({
        title: '',
        text: "",
        html: 'ท่านต้องการจำหน่ายข้อมูล พ.อ. ตัวอย่าง รักชาติ <br> ตำแหน่งและสังกัดปกติ นายทหารปฏิบัติการประจำ สลก.ทบ. หรือไม่?',
        icon: 'warning',
        ...
        if (result.value) {
            $.ajax({
                url:  "PalaceByAssist/updateDistribute",
                method: "post",
                data: {mId: mId},
                dataType: "text",
                success: function (data) {
                    ...
                    if(data == 'success'){
                        Swal.fire({
                            ...
                            window.location = "PalaceByAssist";
                        });
                    }else{
                        Swal.fire({
