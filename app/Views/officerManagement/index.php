                                                    ...
                                                    <td class="text-center">
                                                        <div class="col-auto pe-md-0 ">
                                                            <div class="form-group mb-0">
                                                                <a href="<?php echo base_url('OfficerManagement/history') ?>" class="btn  btn-warning  text-dark">
                                                                    <i class="mdi mdi-file-document"></i>&nbsp;ประวัติ
                                                                </a>
                                                                <a href="<?php echo base_url('OfficerManagement/form/'.$value['fid']) ?>" class="btn  btn-warning  text-dark">
