...
<form  class="needs-validation" novalidate action="<?php echo $action ?>" method="POST" id="strForm">
    <input type="text" id="org_profile_id" name="org_profile_id" value="<?php echo isset($save_data['org_profile_id'])?$save_data['org_profile_id']:$org_profile_id ?>">
    <input type="text" id="org_id" name="org_id" value="<?php echo isset($save_data['org_id'])?$save_data['org_id']:'' ?>">
    <input type="text" id="org_parent" name="org_parent" value="<?php echo isset($save_data['org_parent'])?$save_data['org_parent']:$org_parent ?>">
    <input type="text" id="org_profile_year" name="org_profile_year" value="<?php echo isset($parent_data['org_profile_year'])?$parent_data['org_profile_year']:$save_data['org_profile_year'] ?>">
    <input type="text" id="profileType" name="profileType" value="<?php echo isset($parent_data['profileType'])?$parent_data['profileType']:$save_data['profileType'] ?>">
    <div class="row">
        <div class="col-12">
            <div class="card">
