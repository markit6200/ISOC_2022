...
<form  class="needs-validation" novalidate action="<?php echo $action ?>" method="POST" id="strForm">
    <input type="hidden" id="org_profile_id" name="org_profile_id" value="<?php echo isset($save_data['org_profile_id'])?$save_data['org_profile_id']:'' ?>">
    <input type="hidden" id="org_id" name="org_id" value="<?php echo isset($save_data['org_id'])?$save_data['org_id']:'' ?>">
    <input type="hidden" id="org_parent" name="org_parent" value="<?php echo isset($save_data['org_parent'])?$save_data['org_parent']:'' ?>">
    <div class="row">
        <div class="col-12">
            <div class="card">
