                ...
                <div class="row form-group align-items-baseline">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th scope="col" style="width: 5rem;" class="text-dark fw-bold text-center">เลขที่ตำแหน่ง</th>
                                    <th scope="col" class="text-dark fw-bold text-center" style="width: 85rem;">ชื่อตำแหน่งใน กอ.รมน./<br>ชื่อตำแหน่งในการบริหาร</th>
                                    <th scope="col" class="text-dark fw-bold text-center" style="width: 60rem;">ชื่อ-สกุล</th>
                                    <th scope="col" class="text-dark fw-bold text-center" style="width: 15rem;">ตำแหน่ง</th>
                                    <th scope="col" class="text-dark fw-bold text-center" style="width: 10rem;">ประเภท</th>
                                    <th scope="col" class="text-dark fw-bold text-center" style="width: 15rem;">ชื่อตำแหน่งสายงาน</th>
